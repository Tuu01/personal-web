  ...
  return (
    <footer className="w-full bg-white">
      ...
      <div className="w-full flex justify-center">
        <div className="w-full max-w-[92vw] md:max-w-[80vw]" />
      </div>

      {/* FOOTER CONTENT */}
      <div className="relative w-full max-w-[92vw] md:max-w-[80vw] mx-auto px-4 py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-sm text-neutral-800">
        {/* DASHED GRID LINES */}
        ...
        <div className="z-10 text-sm text-neutral-600 flex flex-col gap-3">
          ...
          <p>(c) 2025 Trong Tu Luu. All Rights Reserved.</p>
          {/* <p className="text-xs">
